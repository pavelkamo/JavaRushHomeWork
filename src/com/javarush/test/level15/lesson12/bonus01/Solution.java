...
public class Solution {
    static {
        try
        {
            Solution.reset();//add your code here - добавьте код тут
        }
        catch (IOException e)
        {
            e.printStackTrace();
    ...
    public static void reset() throws IOException
    {
        ...
        try
        {
            parametr = reader.readLine();//add your code here - добавьте код тут
        }
        catch (IOException e)
        {
        ...
        try
        {
            ...
            {
                int intParam = Integer.parseInt(reader.readLine());
                result = new Plane(intParam);
            }
        }
        catch (Exception e)
        {
